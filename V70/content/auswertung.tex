...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{build/Dreh_Evak.pdf}
...
\begin{table}[H]
  \centering
    ...
    \begin{tabular}{S[table-format=1.0] S[table-format=2.4] @{${}\pm{}$} S[table-format=1.4] S[table-format=2.2] @{${}\pm{}$} S[table-format=1.2]}
      \toprule
      {Regression} & \multicolumn{2}{c}{$a [\si{\per\second}]$} & \multicolumn{2}{c}{$b$} \\
      \midrule
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{build/Turbo_Evak.pdf}
