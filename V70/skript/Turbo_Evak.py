...
np.savetxt('build/Turbo_Evak_Daten.txt', np.column_stack([t, p_m, p_stat, p_sys, noms(ln_p), stds(ln_p)]), fmt='%6.5f', delimiter=' & ', header='t, p, p_stat, p_sys, ln, dln', newline='\\\\\n' )
