...
plt.errorbar(2.68, 2.5, xerr = 0.983,  yerr=0.4, fmt='x', label = "Leck 0.4 hPa")
plt.errorbar(54.2, 4.6, xerr = 36.5,  yerr=0.5, fmt='x', label = "Leck 10 hPa")
plt.errorbar(237,  4.3, xerr = 171,    yerr=0.5, fmt='x', label = "Leck 50 hPa")
plt.errorbar(290,  4.1, xerr = 160,    yerr=0.4, fmt='x', label = "Leck 100 hPa")
plt.errorbar(325,  3.8, xerr = 322,  yerr=0.4, fmt='x', label = "Evakuierung 1")
plt.errorbar(0.255,0.48,xerr = 0.095,yerr=0.08,fmt='x', label = "Evakuierung 2")
plt.xscale('log')
plt.xlabel(r"$p$ $ [hPa]$")
