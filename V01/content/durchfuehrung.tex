...
Der TAC wandelt die Zeitspanne zwischen Start-Signal und Stop-Signal in eine Amplitude, dessen Höhe proportional zu der
...
Zusätzlich sind an den Ausgängen der AND-Gatter Impulszähler angeschlossen, sodass für eine Abschätzung
...
variiert, um die Ereignisrate zu maximieren. Die Suchzeit des Monoflops wird auf $T_\text{S} = \SI{10}{\micro\second} $ eingestellt werden.
