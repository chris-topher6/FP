...
\begin{table}[H]
	...
	\begin{tabular}{S S[table-format=2.2] S[table-format=4.0] S}
		...
		\midrule
		121.7817  & {28.41 \pm  0.13}  & 595   & {8479 \pm 103}   \\
		244.6974  & {7.55 \pm   0.04}  & 1187  & {1597 \pm 40}    \\
		344.2785  & {26.59 \pm  0.12}  & 1666  & {3301 \pm 60}    \\
		443.9650  & {2.80 \pm   0.02}  & 2145  & {424 \pm 25}     \\
		778.9045  & {12.97 \pm  0.06}  & 3760  & {752 \pm 29}     \\
		867.3800  & {4.24 \pm   0.02}  & 4192  & {247 \pm 25}     \\
		964.0790  & {14.50 \pm  0.06}  & 4654  & {621 \pm 26}     \\
		1085.8370 & {10.13 \pm  0.06}  & 5238  & {470 \pm 39}     \\
		1112.0760 & {13.41 \pm  0.06}  & 5370  & {586 \pm 36}     \\
		1408.0130 & {20.85 \pm  0.08}  & 6797  & {627 \pm 26}     \\
		\bottomrule
	\end{tabular}
\end{table}
\begin{figure}[H]
...
\begin{table}[H]
	...
	\begin{tabular}{S  S[table-format=1.5] }
		...
		\midrule
		{121.7817 \pm 0.0003} & {0.0555 \pm 0.0011} \\
		{244.6974 \pm 0.0008} & {0.0393 \pm 0.0012} \\
		{344.2785 \pm 0.0012} & {0.0231 \pm 0.0006} \\
		{443.965 \pm 0.003}   & {0.0281 \pm 0.0017} \\
		{778.9045 \pm 0.0024} & {0.0108 \pm 0.0005} \\
		{867.38 \pm 0.003}    & {0.0108 \pm 0.0011} \\
		{964.079 \pm 0.018}   & {0.0080 \pm 0.0004} \\
		{1085.837 \pm 0.01}   & {0.0086 \pm 0.0007} \\
		{1112.076 \pm 0.003}  & {0.0081 \pm 0.0005} \\
		{1408.013 \pm 0.003}  & {0.0056 \pm 0.0003} \\
		\bottomrule
	\end{tabular}
\end{table}
\noindent
...
\begin{table}[H]
	...
	\begin{tabular}{S S[table-format=4.3] S[table-format=2.0] S[table-format=4.3] S[table-format=2.3]}
		...
		\midrule
		{188.1961 \pm 0.0004} & {1275 \pm 71} & {20.00 \pm 0.46} & {929.28 \pm 1.99}  & {31.26 \pm 2.13} \\
...
\begin{table}[H]
	...
	\begin{tabular}{S S[table-format=4.3] S[table-format=2.0] S[table-format=4.3] S[table-format=2.3]}
		\toprule {$E/\si{\kilo\electronvolt}$} & {$s$}                & {$b$}              & {$\mu$}              & {$\sigma$}        \\
		\midrule
		{1173.3856 \pm 0.0004}                 & {358 \pm 26} & {15.0 \pm 0.4} & {5662.1 \pm 0.4} & {4.4 \pm 0.3} \\
		{1332.2939 \pm 0.0004}                 & {247 \pm 24} & {15.0 \pm 0.5} & {6429.2 \pm 0.5} & {4.4 \pm 0.4} \\
		\bottomrule
	\end{tabular}
\end{table}
\noindent
...
\begin{table}[H]
	...
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{tabular}{S S[table-format=4.4] S[table-format=3.4] S[table-format=3.3] S[table-format=2.4] S[table-format=4.0] S[table.format=1.4]}
			...
			\midrule
			{1173.3856 \pm 0.0004}                 & {995 \pm 138} & {358 \pm 26} & {99.85 \pm 0.03}     & {4021}             & {0.0074 \pm 0.0009} \\
			{1332.2939 \pm 0.0004}                 & {771 \pm 118} & {247 \pm 24} & {99.9826 \pm 0.0006} & {4021}             & {0.0066 \pm 0.0008} \\
			\bottomrule
		\end{tabular}
	\end{adjustbox}
\end{table}
...
\begin{figure}[H]
	...
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak1.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak2.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
	% Zweite Zeile
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak3.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak4.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
	% Dritte Zeile
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak5.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak6.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
...
\begin{figure}[H]
	...
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak7.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak8.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
	% Fünfte Zeile
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak9.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak10.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
	% Sechste Zeile
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak11.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak12.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
...
\begin{figure}[H]
	...
	\begin{adjustbox}{width=1.3\textwidth, center}
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak13.pdf}
			% \caption{Plot 1}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[width=\linewidth]{./build/Uran-Fit-Peak14.pdf}
			% \caption{Plot 2}
		\end{subfigure}
	\end{adjustbox}
	\caption{Fits of the peaks of the uranium spectrum.}
