...
% \begin{table}[H]
% 	\centering
% 	\caption{Energy and the calculated full energy detection probability of the two peaks of the $^{137}\text{Cs}$ spectrum with more than $\SI{150}{\kilo\electronvolt}$.}
% 	\label{tab:calibrationvalues}
% 	\sisetup{table-format=4.4}
% 	\begin{tabular}{S  S[table-format=1.5] }
% 		\toprule {$E_{\text{lit}}/\si{\kilo\electronvolt}$} & {$Q/\si{\percent}$}     \\
% 		\midrule
% 		{303.87376 \pm 0.00029}         				                    & { 0.06409 \pm  0.0030}  \\
% 		{800.13725 \pm 0.00029}                                           & { 0.00571 \pm  0.00026} \\
% 		\bottomrule
% 	\end{tabular}
% \end{table}
% \noindent
...
\begin{table}[H]
	...
	\begin{tabular}{S S[table-format=4.3] S[table-format=2.0] S[table-format=4.3] S[table-format=2.3]}
		...
		\midrule
		{303.87376 \pm 0.00029}                & {1275.237 \pm 70.842} & {20.000 \pm 0.457} & {929.282 \pm 1.989}  & {31.257 \pm 2.129} \\
		{800.13725 \pm 0.00029}                & {9282.567 \pm 98.438} & {15.000 \pm 0.165} & {3195.882 \pm 0.050} & {4.494 \pm 0.038}  \\
		\bottomrule
	\end{tabular}
\end{table}
\noindent
...
of the $^{137}\text{Cs}$ spectrum are estimated. To do this, the fitted normal distribution is utilized. The half max
